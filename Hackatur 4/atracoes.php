...
<body id="page-top">
        ...
        <style>
        .a {text-shadow: 0.1em 0.1em 0.05em #333}
        .b {text-shadow: 0.1em 0.1em 0.3em black}
        .logo{
            height:50px;
            margin: 0px;
            padding: 0px;
  ...
  <nav class="navbar navbar-expand-lg navbar-dark fixed-top" style="background-color: #212529;" id="mainNav">
    <div class="container">
        <div class="container">
        <a class="navbar-brand js-scroll-trigger" href="/index.php" style="font-family: 'Lobster', cursive;">
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav text-uppercase ml-auto">
          <li class="nav-item">
            <a class="nav-link js-scroll-trigger b" href="/index.php">Home</a>
          </li>
          <li class="nav-item">
            <a class="nav-link js-scroll-trigger b" href="#portfolio">Eventos</a>
          </li>
          <li class="nav-item">
    ...
    <div class="row">
      ...
      <div class="col-lg-9">
        ...
        <div class='col-lg-4 col-md-6 mb-4'>
            <div class='card h-100'>
            < img src="img/comida1.jpg" class="card-img-top">
              <div class='card-body'>
                <h4 class='card-title'>João</a></h4>
                <h5>$24.99</h5>Muito Bom</div>
              <div class='card-footer'>
                <small class='text-muted'>&#9733; &#9733; &#9733; &#9733; &#9734;</small>
              </div>
            </div>
