  ...
  <header class="masthead">
    <div class="container">
      <div class="intro-text">
        ...
        <div class="intro-heading text-uppercase">Sua experiência turística começa aqui</div>
        <a class="btn btn-primary btn-xl text-uppercase js-scroll-trigger" href="cadastroUsuario.php">Primeiro Acesso</a>
      </div>
    </div>
  </header>
